...
.btn_music.on {
	...
	<!-- 	<span id="playbox" class="btn_music" onclick="playbox.init(this).play();"><audio id="audio" -->
	<!-- 			loop src="images/4.mp3"></audio></span> -->
...
<!-- 				<li><a href="/"><b><img src="images/tb06.png" /></b><span>证明查询</span></a></li> -->
				<li><a href="toDqcx.jsp"><b><img src="images/tb01.png" /></b><span>到期查询</span></a></li>
	</ul>
	...
	<div class="copyright">
		<br /> <br />Copyright © 2015-2016 <a href="http://slgps.com.cn">神龙科技</a> All rights reserved.
	</div>
