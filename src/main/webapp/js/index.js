...
function GetMenuList(data, menulist) {
    if (data.children == null){
        ...
        $.each(data.children, function(i, sm) {
            if (sm.url != "") {
//                menulist += '<li><a name="' + sm.name + '" ref="' + sm.id+ '" href="#" rel="' + sm.url + '" ><span>' + sm.name + '</span></a>'
                menulist += '<li><span><a rel="' + sm.url + '" href="#"  name="' + sm.name + '" ref="' +  sm.id + '">' + sm.name + '</a></span>';
            }else {
                menulist += '<li><span>' + sm.name + '</span>'
            }
...
function addNav(data) {
    ...
    $.each(data, function(i, sm) {
        ...
        menulist1 = '<ul id="tt" class="easyui-tree" data-options="animate:true,lines:true">' + menulist1.substring(4);
        $('#wnav').accordion('add', {
            title: sm.name,
            content: menulist1,
