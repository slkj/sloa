		...
		$("#search_btn").click(function() {
			$('#listGrid').datagrid({				
				queryParams : {
					...
					seasonExamE1 : $('#seasonExamE1').val(),
					seasonExamE2 : $('#seasonExamE2').val()
				}
			});
				...
				.datagrid(
						{
							...
							rowStyler : function(index, row) {
								...
								var now = new Date();
								var date = new Date(row.seasonExamE);
				...
				<div id="cot">
					<div class="shang">
						...
						车主：<input id="carOwner" style="width: 150px" /> 
						 到期时间：<input id="seasonExamE1"
							class="Wdate" type="text"
							onFocus="WdatePicker({isShowClear:false,readOnly:true})" /> - <input
							id="seasonExamE2" class="Wdate" type="text"
