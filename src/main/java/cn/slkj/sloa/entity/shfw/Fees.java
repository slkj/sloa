...
public class Fees {
	...
	public String toString() {
		return "Fees [id=" + id + ", carNumber=" + carNumber + ", owner=" + owner + ", number=" + number + ", startTime=" + startTime + ", endTime=" + endTime + ", colAmounts=" + colAmounts + ", riqi=" + riqi + ", agent=" + agent + ", depCode=" + depCode + ", depName=" + depName + ", fees=" + fees + ", amounts=" + amounts + ", sriqi=" + sriqi + ", remark=" + remark + "]";
	}
