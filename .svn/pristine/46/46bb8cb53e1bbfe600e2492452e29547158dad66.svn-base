	...
	<form id="comForm">
		...
		<table class="grid">
			...
			<tr>
				...
				<td colspan="3"><input name="compName" class="easyui-textbox" data-options="required:'true'"
			...
			<tr>
				<th>简介(经营范围)</th>
				<td colspan="3"><input name="introduction" class="easyui-textbox" data-options="multiline:true"
